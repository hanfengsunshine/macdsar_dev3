...
class Strategy:
    def __init__(self, exchange, global_symbol, strategy_helper_instance: StrategyTradingHelper):
        ...
        self.lead_buffer = Decimal(2400)    # max lead amount  3000
        self.lead_min = Decimal(600)        # min lead amount  500
        self.hedge_buffer = Decimal(1800)   # max target level order size 1000
        ...
        self.drop_th = Decimal(1500)         # min last trade/cancel size 200
        self.trade_th = Decimal(750)        # min trade volume           300
        self.book_th1 = Decimal('2.5')      # >= 1.0
        self.book_th2 = Decimal('2.5')      # >= 1.0
