...
class Strategy:
    def __init__(self, exchange, global_symbol, strategy_helper_instance: StrategyTradingHelper):
        ...
        self.weights = [Decimal('1.0'), Decimal('1.0')]
        ...
        self.lead_buffer = Decimal(2000)    # max lead amount  3000
        self.lead_min = Decimal(400)        # min lead amount  500
        self.hedge_buffer = Decimal(1500)   # max target level order size 1000

        self.bluff_size = Decimal(0)        # size of bluffing order  1000
        self.delta_ignore = Decimal(30)     # size of level-support residual 155
        self.delta_guard = Decimal(1000)    # size of delta_guard

        self.drop_th = Decimal(100)         # min last trade/cancel size 200
        self.trade_th = Decimal(450)        # min trade volume           300
        self.book_th1 = Decimal('1.5')      # >= 1.0
        self.book_th2 = Decimal('1.5')      # >= 1.0
