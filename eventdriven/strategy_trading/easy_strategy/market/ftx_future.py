...
class FtxFutureMarket(MarketBase):
    ...
    async def _run_ws(self):
        ...
        logger.info('ftx future market connected')
        ...
        try:
            ...
            logger.warning('ftx future market disconnectd. error={}', e)
            await self._reconnect()
            return
    ...
    async def _subscribe_topic(self, topic):
        ...
        if self._ws:
            logger.info('[ftx][future][s] {}', request)
            try:
    ...
    async def _on_ws_message(self, message: str):
        ...
        if 'channel' not in message:
            logger.info('[ftx][future][r] {}', message)
            return
