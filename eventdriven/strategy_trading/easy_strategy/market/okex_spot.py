...
class OkexSpotMarket(MarketBase):
    ...
    async def _run_ws(self):
        ...
        logger.info('okex spot market connected')
        ...
        try:
            ...
            logger.warning('okex spot market disconnectd. error={}', self._url, e)
            await self._reconnect()
            return
    ...
    async def _subscribe_topic(self, topic):
        ...
        if self._ws:
            logger.info('[okex][spot][s] {}', request)
            try:
    ...
    async def _on_ws_message(self, message: str):
        ...
        if 'event' in message:
            logger.info('[okex][spot][r] {}', message)
            return
